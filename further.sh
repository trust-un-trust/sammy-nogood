# tested full remove list 10.12.21
...
adb shell pm uninstall --user 0 com.samsung.android.app.aodservice
...
adb shell pm uninstall --user 0 com.samsung.android.app.earphonetypec
...
adb shell pm uninstall --user 0 com.sec.android.app.ewidgetatt
